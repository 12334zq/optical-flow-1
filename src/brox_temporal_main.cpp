 ...
 *   -dir         output directory to store the flows (flow00.flo ... flowNN.flo)
     ...
     char *argv[])
{
    if (argc < 3) {
        ...
        if (correct) {
            ...
            ofpix_t *u = new ofpix_t[nx * ny * (frames - 1)];
            ofpix_t *v = new ofpix_t[nx * ny * (frames - 1)];
