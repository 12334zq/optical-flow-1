...
void
me_sepconvol(const ofpix_t *in,
             ofpix_t *out,
             int nx,
             int ny,
             const ofpix_t *filter_x,
             const ofpix_t *filter_y,
             int size_x,
             int size_y)
{
    ofpix_t *tmp;
...
static
int
me_median_compare(const void *i,
                  const void *j)
{
    ofpix_t *val1, *val2;
...
void
me_median_filtering(ofpix_t *in,
                    int nx,
                    int ny,
                    int wsize)
{
 ...
 **/
void
image_normalization_1(const ofpix_t *I,       //input images
                      ofpix_t       *In,      //normalized output images
 ...
 **/
void
image_normalization_2(const ofpix_t *I1,      //input image 1
...
void
image_normalization_4(const ofpix_t *I_1,      // input image-1
 ...
 **/
void
getminmax(ofpix_t *min,          // output min
