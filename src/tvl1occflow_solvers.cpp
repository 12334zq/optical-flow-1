...
void Solver_wrt_v(ofpix_t *u1, ofpix_t *u2, ofpix_t *v1, ofpix_t *v2, ofpix_t *chi,
		const ofpix_t *I1wx, const ofpix_t *I1wy, const ofpix_t *I_1wx,
		const ofpix_t *I_1wy, const ofpix_t *rho1_c, const ofpix_t *rho3_c,
		ofpix_t *Vfwd_1, ofpix_t *Vfwd_2, ofpix_t *Vbck_1, ofpix_t *Vbck_2, const ofpix_t *grad1,
		const ofpix_t *grad3, const double alpha, const double theta,
...
void Solver_wrt_u(ofpix_t *u1, ofpix_t *u2, const ofpix_t *v1, const ofpix_t *v2,
		const ofpix_t *chi, const ofpix_t *g, const double theta,
...
void Solver_wrt_chi(const ofpix_t *u1, const ofpix_t *u2, ofpix_t *chi,
		const ofpix_t *I1wx, const ofpix_t *I1wy, const ofpix_t *I_1wx,
		const ofpix_t *I_1wy, const ofpix_t *rho1_c, const ofpix_t *rho3_c,
		const ofpix_t *Vfwd_1, const ofpix_t *Vfwd_2, const ofpix_t *Vbck_1,
		const ofpix_t *Vbck_2, const ofpix_t *g, const double lambda,
