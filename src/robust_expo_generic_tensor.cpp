 ...
 */
void
robust_expo_psi_divergence(ofpix_t *psi1, //coefficients of divergence
                           ofpix_t *psi2,
                           ofpix_t *psi3,
                           ofpix_t *psi4,
 ...
 */
void
robust_expo_divergence(const ofpix_t *u, //component of optical flow
