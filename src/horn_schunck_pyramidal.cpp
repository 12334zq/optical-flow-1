 ...
 */
void
horn_schunck_optical_flow(const ofpix_t *I1, // source image
...
{
    if (verbose) {
        fprintf(stderr, "Single-scale Horn-Schunck of a %dx%d "
 ...
 */
void
horn_schunck_pyramidal(const ofpix_t *I1, // source image
                       const ofpix_t *I2, // target image
                       ofpix_t       *u,// x component of optical flow
                       ofpix_t       *v,// y component of optical flow
                       const int nx, // image width
...
{
    if (verbose) {
        fprintf(stderr, "Multiscale Horn-Schunck of a %dx%d pair"
